...
For the complete walkthrough (prerequisites, every wizard step explained, SSH access, daily operations, troubleshooting), see the [Getting Started](../../getting-started/prerequisites) guide.

If you'd rather drive the playbooks yourself, see the [Manual setup](../../operations/manual-setup) page.

## Supported platforms

range42 is developed and tested on Ubuntu LTS (Desktop / Server) and is also expected to work on Debian 13. Full details and prerequisites: [Prerequisites](../../getting-started/prerequisites).
